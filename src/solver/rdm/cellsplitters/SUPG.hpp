#ifndef PDEKIT_RDM_SUPG_hpp
#define PDEKIT_RDM_SUPG_hpp
...
// Tag class to mark SUPG with variable beta coefficients
...
template <typename Physics>
SUPGImplementation<Physics>::SUPGImplementation()
{
}
...
template <typename Physics>
template <typename CellGeoMetType, typename CellSolMetType, typename CellFluxMetType>
void SUPGImplementation<Physics>::compute_adv_residuals(
    math::DenseConstMatView<Real> const &sol_nodal_values,
    const RDMethodConstData<CellGeoMetType, CellSolMetType, CellFluxMetType> &ConstMD,
    RDMethodScratchData<Physics> &MD)
{
...
template <typename Physics>
template <typename CellGeoMetType, typename CellSolMetType, typename CellFluxMetType>
void SUPGImplementation<Physics>::compute_adv_res_and_jacobian(
    math::DenseConstMatView<Real> const &sol_nodal_values,
    const RDMethodConstData<CellGeoMetType, CellSolMetType, CellFluxMetType> &ConstMD,
    RDMethodScratchData<Physics> &MD)
{
...
template <typename Physics>
template <typename MD1, typename MD2>
void SUPGImplementation<Physics>::compute_adv_residuals_no_flux_metric(
    math::DenseConstMatView<Real> const &sol_nodal_values,
...
template <typename Physics>
template <typename CellGeoMetType, typename CellSolMetType, typename CellFluxMetType>
void SUPGImplementation<Physics>::compute_adv_reaction_residuals(
    math::DenseConstMatView<Real> const &sol_nodal_values,
    const RDMethodConstData<CellGeoMetType, CellSolMetType, CellFluxMetType> &ConstMD,
    RDMethodScratchData<Physics> &MD)
{
...
template <typename Physics>
struct CellSchemeSelector<Physics, SUPG>
{
  typedef SUPGImplementation<Physics> type;
};
