#ifndef PDEKIT_Math_Scalar_DVec_Mult_Expr_Proxy_hpp
#define PDEKIT_Math_Scalar_DVec_Mult_Expr_Proxy_hpp
...
class ScalarDVecMultExprProxy : public DenseVector<ScalarDVecMultExprProxy<ST, VT, TF>, TF>
{
  private:
  ...
  using composite_type = const ScalarDVecMultExprProxy &;
  ...
  static_assert(!VT::owns_data, "ScalarDVecMultExprProxy can only be used with "
  ...
  /// Constructor
  ScalarDVecMultExprProxy(const ST &scalar_left, const VT &vec_right)
  ...
  friend inline void free_assign(DenseVector<VT2, TF> &lhs, const ScalarDVecMultExprProxy &rhs)
  {
    ScalarDVecMultExprProxy::assign(lhs.wrapped_type(), rhs.m_scalar, rhs.m_vec);
  }
...
template <typename ST, typename VT, bool TF>
struct TensorRank<ScalarDVecMultExprProxy<ST, VT, TF>>
{
  enum
  {
    value = tensor_rank_1
