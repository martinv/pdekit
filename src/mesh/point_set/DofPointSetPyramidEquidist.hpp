#ifndef PDEKIT_Mesh_Dof_Point_Set_Pyramid_Equidist_hpp
#define PDEKIT_Mesh_Dof_Point_Set_Pyramid_Equidist_hpp
...
// ----------------------------------------------------------------------------
// Equidistant point set for pyramid
// ----------------------------------------------------------------------------

class DofPointSetPyramidEquidist : public StdPointSetBase
{
  public:
  /// Default constructor
  DofPointSetPyramidEquidist(const std::tuple<Uint> &p_order);

  /// Destructor
  ~DofPointSetPyramidEquidist() override = default;

  static std::string type_name()
  {
    return "DofPointSetPyramidEquidist";
  }
  ...
  private:
  using std_reg_t = mesh::EquidistStdRegionPyramid;
