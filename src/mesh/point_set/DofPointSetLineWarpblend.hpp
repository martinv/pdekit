#ifndef PDEKIT_Mesh_Dof_Point_Set_Line_Warpblend_hpp
#define PDEKIT_Mesh_Dof_Point_Set_Line_Warpblend_hpp
...
class DofPointSetLineWarpblend : public StdPointSetBase
{
  public:
  /// Default constructor
  DofPointSetLineWarpblend(const std::tuple<Uint> &p_order);

  /// Destructor
  ~DofPointSetLineWarpblend() override = default;

  static std::string type_name()
  {
    return "DofPointSetLineWarpblend";
  }
  ...
  private:
  using std_reg_t = mesh::WarpblendStdRegionLine;
