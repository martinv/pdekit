#ifndef PDEKIT_Mesh_Shape_Function_Modal_Expansion_Hexa_hpp
#define PDEKIT_Mesh_Shape_Function_Modal_Expansion_Hexa_hpp
...
class ModalExpansionHexa : public ModalExpansion
{
  public:
  /// Default constructor
  ModalExpansionHexa();
  ...
  ModalExpansionHexa(const Uint poly_order);

  /// Destructor
  ~ModalExpansionHexa() override;
