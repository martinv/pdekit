#ifndef PDEKIT_Mesh_Shape_Function_Carnevali_Expansion_Triag_hpp
#define PDEKIT_Mesh_Shape_Function_Carnevali_Expansion_Triag_hpp
...
class CarnevaliExpansionTriag : public ModalExpansion
{
  public:
  /// Default constructor
  CarnevaliExpansionTriag();

  /// Constructor which sets the polynomial order
  CarnevaliExpansionTriag(const Uint poly_order);

  /// Destructor
  ~CarnevaliExpansionTriag() override;
