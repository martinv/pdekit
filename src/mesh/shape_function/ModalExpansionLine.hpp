#ifndef PDEKIT_Mesh_Shape_Function_Modal_Expansion_Line_hpp
#define PDEKIT_Mesh_Shape_Function_Modal_Expansion_Line_hpp
...
class ModalExpansionLine : public ModalExpansion
{
  public:
  /// Default constructor
  ModalExpansionLine();
  ...
  ModalExpansionLine(const Uint poly_order);

  /// Destructor
  ~ModalExpansionLine() override;
