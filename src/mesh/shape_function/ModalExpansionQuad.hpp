#ifndef PDEKIT_Mesh_Shape_Function_Modal_Expansion_Quad_hpp
#define PDEKIT_Mesh_Shape_Function_Modal_Expansion_Quad_hpp
...
class ModalExpansionQuad : public ModalExpansion
{
  public:
  /// Default constructor
  ModalExpansionQuad();
  ...
  ModalExpansionQuad(const Uint poly_order);

  /// Destructor
  ~ModalExpansionQuad() override;
