#ifndef PDEKIT_Mesh_Shape_Function_Orthonormal_Prime_Basis_Tetra_hpp
#define PDEKIT_Mesh_Shape_Function_Orthonormal_Prime_Basis_Tetra_hpp
...
#define USE_SINGULARITY_FREE_EVALUATION_ON_TETRA 1
...
class DubinerExpansionTetra : public ModalExpansion
{
  public:
  /// Default constructor
  DubinerExpansionTetra();

  /// Constructor which sets the polynomial order
  DubinerExpansionTetra(const Uint poly_order);

  /// Destructor
  ~DubinerExpansionTetra() override;
...
//
  ...
  inline static Uint mode_id(const Uint p, const Uint q, const Uint r)
  {
