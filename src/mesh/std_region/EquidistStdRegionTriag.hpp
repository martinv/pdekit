#ifndef PDEKIT_Mesh_Interpolation_Equidist_Std_Region_Triag_hpp
#define PDEKIT_Mesh_Interpolation_Equidist_Std_Region_Triag_hpp
...
// ----------------------------------------------------------------------------
// EQUIDISTANT STANDARD REGION ON TRIANGLES
// ----------------------------------------------------------------------------

class EquidistStdRegionTriag
{
  public:
  ...
  EquidistStdRegionTriag() = default;
  ...
  private:
  friend class WarpblendStdRegionTriag;
