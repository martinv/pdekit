#ifndef PDEKIT_Mesh_Interpolation_Equidist_Std_Region_Line_hpp
#define PDEKIT_Mesh_Interpolation_Equidist_Std_Region_Line_hpp
...
// ----------------------------------------------------------------------------
// EQUIDISTANT STANDARD REGION ON LINES
// ----------------------------------------------------------------------------

class EquidistStdRegionLine
{
  public:
  static constexpr PointSetID Type     = PointSetID::Equidist;
  static constexpr ElemShape GeomShape = ElemShape::Line;
  static constexpr Uint TopoDim        = ElementTopology<ElemShape::Line>::TopoDim;
  static constexpr Uint NbVert         = ElementTopology<ElemShape::Line>::NbVerts;
  static const std::array<Uint, 4> TopologyStorage;
  static constexpr Real ref_measure = 2.0;

  EquidistStdRegionLine() = default;
  ...
  private:
  friend class WarpblendStdRegionLine;
