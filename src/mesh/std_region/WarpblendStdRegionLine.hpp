#ifndef PDEKIT_Mesh_Interpolation_Warpblend_Std_Region_Line_hpp
#define PDEKIT_Mesh_Interpolation_Warpblend_Std_Region_Line_hpp
...
// ----------------------------------------------------------------------------
// WARPBLEND POINT SET ON LINES
// ----------------------------------------------------------------------------

class WarpblendStdRegionLine
{
  public:
  ...
  WarpblendStdRegionLine() = default;
