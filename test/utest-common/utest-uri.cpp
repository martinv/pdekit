...
BOOST_AUTO_TEST_CASE(uri_constructors)
{
  // empty contructor
  URI p0;
...
BOOST_AUTO_TEST_CASE(protocol_management)
{
  ...
  BOOST_CHECK_EQUAL(uri.uri_type(), URIType::CPATH);
  ...
  BOOST_CHECK_EQUAL(uri2.uri_type(), URIType::CPATH);
  ...
  BOOST_CHECK_EQUAL(uri3.uri_type(), URIType::FILE);
  ...
  BOOST_CHECK(true);
  BOOST_CHECK_EQUAL(uri4.uri_type(), URIType::HTTP);
  ...
  BOOST_CHECK_EQUAL(uri5.uri_type(), URIType::HTTPS);
  ...
  BOOST_CHECK_EQUAL(uri6.uri_type(), URIType::HTTP);
